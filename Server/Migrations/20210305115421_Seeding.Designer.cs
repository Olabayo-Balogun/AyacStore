...
namespace AyacStore.Server.Migrations
{
    ...
    [Migration("20210305115421_Seeding")]
            ...
            modelBuilder.Entity("AyacStore.Shared.Product", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            CategoryId = 1,
                            DateCreated = new DateTime(2021, 3, 5, 12, 54, 20, 69, DateTimeKind.Local).AddTicks(9135),
                        ...
                        new
                        {
                            Id = 2,
                            CategoryId = 2,
                            DateCreated = new DateTime(2021, 3, 5, 12, 54, 20, 72, DateTimeKind.Local).AddTicks(8187),
                            DateUpdated = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                        ...
                        new
                        {
                            Id = 4,
                            CategoryId = 1,
                            DateCreated = new DateTime(2021, 3, 5, 12, 54, 20, 72, DateTimeKind.Local).AddTicks(8240),
                            DateUpdated = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                        ...
                        new
                        {
                            Id = 5,
                            CategoryId = 3,
                            DateCreated = new DateTime(2021, 3, 5, 12, 54, 20, 72, DateTimeKind.Local).AddTicks(8249),
                            DateUpdated = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                        ...
                        new
                        {
                            Id = 6,
                            CategoryId = 3,
                            DateCreated = new DateTime(2021, 3, 5, 12, 54, 20, 72, DateTimeKind.Local).AddTicks(8254),
                            DateUpdated = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                        ...
                        new
                        {
                            Id = 7,
                            CategoryId = 2,
                            DateCreated = new DateTime(2021, 3, 5, 12, 54, 20, 72, DateTimeKind.Local).AddTicks(8259),
                            DateUpdated = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                        ...
                        new
                        {
                            Id = 8,
                            CategoryId = 2,
                            DateCreated = new DateTime(2021, 3, 5, 12, 54, 20, 72, DateTimeKind.Local).AddTicks(8269),
                            DateUpdated = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
